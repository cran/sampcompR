...
#' ###################################################################
#' 
#' extract_interaction_results2<-function(glm_model, robust_se=F){
#'   
#'   
...
#' 
#' 
#' final_glm_list<-function(glm_list, formula_list ,weight_var=NULL,robust_se=F, p_adjust=NULL,out_models=F){
#'   
#'   output_list<-list()
...
#'       bmatrix_diff_help<- as.matrix(extract_interaction_results2(glm_list[[1]][[i]],robust_se=F)[,1])
#'       
#' 
...
#'         pmatrix_diff_help<- as.matrix(extract_interaction_results2(glm_list[[1]][[i]],robust_se=F)[,3])
...
#'         se_matrix_help<- as.matrix(extract_interaction_results2(glm_list[[1]][[i]],robust_se=F)[,2])
...
#'         pmatrix_diff_help<- as.matrix(extract_interaction_results2(glm_list[[1]][[i]],robust_se=T)[,3])
...
#'         se_matrix_help<- as.matrix(extract_interaction_results2(glm_list[[1]][[i]],robust_se=T)[,2])
...
#'                          robust_se = robust_se, p_adjust = p_adjust,out_models = out_models)
#'   
#'   
